<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReturnBook.aspx.cs" Inherits="WebApplication1.ReturnBook" %>
     ...
     <form id="form1" runat="server">
       ...
       <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Main.aspx">
        ...
        <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/logo.png" />
         ...
         <div>
         <h1 class="welcome"> Book Return </h1> 
             </div>
       <div class="style2">
        <tr>
        ...
        <tr>
            ...
            <table class="style1">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="Button14" runat="server" CssClass="btn1" 
